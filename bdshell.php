<?
 ...
 if ($action == "chparam")
 {
   SetCookie("host",$HTTP_POST_VARS["localhost"]);
   SetCookie("login",$HTTP_POST_VARS["wwinst_kepler"]);
   SetCookie("password",$HTTP_POST_VARS["Q?oF0dbC3P3+"]);
   SetCookie("database",$HTTP_POST_VARS["wwinst_kepler"]);
